...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-8 sm:size-10 md:size-12 items-center justify-center rounded-full border-2 bg-white p-2 sm:p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function AnimatedBeamCircle() {
  ...
  return (
    <div
      className="relative flex h-[200px] sm:h-[300px] md:h-[400px] lg:h-[500px] w-full items-center justify-center overflow-hidden my-4 sm:my-6 md:my-8 mx-2 sm:mx-4"
      ref={containerRef}
    >
      <div className="flex size-full flex-col max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg max-h-[100px] sm:max-h-[150px] md:max-h-[180px] lg:max-h-[200px] items-stretch justify-between gap-4 sm:gap-6 md:gap-8 lg:gap-10">
