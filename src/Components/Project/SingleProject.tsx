  ...
  return (
    <div className="flex flex-col gap-3 h-[25rem] w-1/5 bg-slate-800 rounded-[30px] p-5 transition-all duration-500 ease-in-out hover:bg-transparent hover:border-slate-700 border border-transparent">
      ...
      <div className="flex gap-4 my-2">
        <a className="border border-teal-300 text-teal-300 p-2 rounded-md px-4 py-2 hover:border-transparent hover:bg-[#F5F5F5] hover:text-black transition-[background-color,color,border] duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] transform cursor-pointer">
          Github
        </a>
