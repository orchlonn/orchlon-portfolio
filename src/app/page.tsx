      ...
      <div className="flex h-[18rem] max-w-3xl bg-[#F5F5F5] px-4 my-10 items-center rounded-lg">
        ...
        <div className="">
          ...
          <p>
            ...
            continuously expanding my skills across the tech landscape. I&apos;m
            especially motivated by the opportunity to solve real-world problems
            through technology. Collaboration and adaptability are at the core
            of how I work and grow.
          </p>
        </div>
      </div>
